...
for (t in 1:(n.yr-1)){ 
    ...
    NJ[t] <-  N[1,t] + aug[t] # number of first years
    } # t
...
# Observation process    
    ...
    for (t in 1:(n.yr-1)){
    #Survival
    phiJ[i,t] <- eta.JSalpha[sex[i],t] # first year
    phiF[i,t] <- eta.FSalpha[t] # nonbreeder
    ...
    #Re-encounter
    pF[i,t] <- eta.pF[hacked[i],t] # resight of nonbreeders
